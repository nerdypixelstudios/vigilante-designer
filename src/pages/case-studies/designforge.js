...
export default function DesignForgeCaseStudy() {
  return (
    <>
      <Navigation />
      <main style={{ minHeight: '100vh', padding: '4rem 1.5rem', maxWidth: '900px', margin: '0 auto' }}>
        ...
        <h1 className="font-cabinet font-extrabold text-ink-950 text-h1 leading-none mb-4">
          DesignForge Methodology
        </h1>
        <p className="font-dm font-normal text-body text-ink-700 leading-relaxed mb-8" style={{ maxWidth: '600px' }}>
          A spec-to-ship framework that cuts delivery from months to weeks.
          Full case study content will be written and added in a later session.
        </p>
        <div className="flex gap-3 flex-wrap mb-12">
          {['Framework', 'Process Design', 'AI Workflow'].map(tag => (
